...
const Listar = async (descricao, limit, skip) => {
    return new Promise((resolve, reject) => {
        ...
        ssql += ' ID, DESCRICAO, CREATED_AT, UPDATED_AT FROM FABCOMP_TIPOMATERIAL WHERE DELETED_AT IS NULL ';
        const params = [];
...
const Inserir = (descricao, callback) => {
    let ssqlMaxId = "SELECT MAX(ID) AS MAX_ID FROM FABCOMP_TIPOMATERIAL";
    ...
    firebird.attach(dbOptions, (err, db) => {
        ...
        db.query(ssqlMaxId, [], (err, result) => {
            ...
            let ssqlInsert = "INSERT INTO FABCOMP_TIPOMATERIAL(ID, DESCRICAO, CREATED_AT) VALUES(?, ?, CURRENT_TIMESTAMP) RETURNING ID";
...
const Editar = (id, descricao) => {
    return new Promise((resolve, reject) => {
        let ssql = 'UPDATE FABCOMP_TIPOMATERIAL SET UPDATED_AT = CURRENT_TIMESTAMP, ';
        const params = [];
...
const Deletar = (id) => {
    return new Promise((resolve, reject) => {
        let ssql = 'UPDATE FABCOMP_TIPOMATERIAL SET DELETED_AT = CURRENT_TIMESTAMP, ';
        const params = [];
...
const Deletar2 = (id, callback) => {
    let params = [id]
    let ssql = "DELETE FROM FABCOMP_TIPOMATERIAL WHERE ID = ? "; //AND DELETED_AT = ''
