...
const Listar = async (descricao) => {
    return new Promise((resolve, reject) => {
        let ssql = 'SELECT ID, DESCRICAO, CREATED_AT, UPDATED_AT FROM FABCOMP_SG1_TM WHERE DELETED_AT IS NULL ';
        const params = [];
...
const Inserir = (descricao, callback) => {
    let ssqlMaxId = "SELECT MAX(ID) AS MAX_ID FROM FABCOMP_SG1_TM";
    ...
    firebird.attach(dbOptions, (err, db) => {
        ...
        db.query(ssqlMaxId, [], (err, result) => {
            ...
            let ssqlInsert = "INSERT INTO FABCOMP_SG1_TM(ID, DESCRICAO, CREATED_AT) VALUES(?, ?, CURRENT_TIMESTAMP) RETURNING ID";
...
const Editar = (id, descricao) => {
    return new Promise((resolve, reject) => {
        let ssql = 'UPDATE FABCOMP_SG1_TM SET UPDATED_AT = CURRENT_TIMESTAMP, ';
        const params = [];
...
const Deletar = (id) => {
    return new Promise((resolve, reject) => {
        let ssql = 'UPDATE FABCOMP_SG1_TM SET DELETED_AT = CURRENT_TIMESTAMP, ';
        const params = [];
...
const Deletar2 = (id, callback) => {
    let params = [id]
    let ssql = "DELETE FROM FABCOMP_SG1_TM WHERE ID = ? "; //AND DELETED_AT = ''
